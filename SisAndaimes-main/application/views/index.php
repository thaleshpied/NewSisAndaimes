    ...
    <div class="container-scroller">
      ...
      <div class="page-body-wrapper">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="application/#tables" aria-expanded="false" aria-controls="tables">
                  ...
                  <div class="mb-3 mb-xl-0 pr-1">
                      <div class="dropdown">
                        <button class="btn bg-white btn-sm dropdown-toggle btn-icon-text border mr-2" type="button" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="typcn typcn-calendar-outline mr-2"></i>Obra - Vale Verde - MG
                        </button>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton3" data-x-placement="top-start">
                          <h6 class="dropdown-header">Obra - Vale XXXX </h6>
                          <a class="dropdown-item" href="application/#">Obra - Vale YYYY </a>
                          <a class="dropdown-item" href="application/#">Obra - Vale ZZZZ </a>
                        </div>
                      </div>
                  </div>

                  <div class="pr-1 mb-3 mr-2 mb-xl-0">
                    <button type="button" class="btn btn-sm bg-white btn-icon-text border"><i class="typcn typcn-arrow-forward-outline mr-2"></i>Obra - Vale Verde - MG</button>
                  </div>
                  <div class="pr-1 mb-3 mb-xl-0">
                    <button type="button" class="btn btn-sm bg-white btn-icon-text border"><i class="typcn typcn-info-large-outline mr-2"></i>Gaveteiro</button>
                  </div>
                </div>
              </div>
            </div>
...
<div class="main-panel">
    ...
    <!-- container-scroller -->
    <!-- base:js -->
    <script src="application/vendors/js/vendor.bundle.base.js"></script>
<!-- AJUSTAR POIS CARREGUEI SÓ PARA CORRIGIR USUARIO -->
<script>
...
!function(t, e) {
    ...
    <!-- endinject -->
    <!-- inject:js -->
    <script src="application/template/js/off-canvas.js"></script>
    <script src="application/template/js/hoverable-collapse.js"></script>
    <script src="application/template/js/template.js"></script>
    <script src="application/template/js/settings.js"></script>
    <script src="application/template/js/todolist.js"></script>
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="application/vendors/chart.js/Chart.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page-->
    <script src="application/template/js/chart.js"></script> 
